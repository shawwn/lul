...
@mixin(Q)
class Q:
    file_error = build_lisp_symbol("file-error")
    stderr = build_lisp_symbol("stderr")
    stdout = build_lisp_symbol("stdout")
    stdin = build_lisp_symbol("stdin")
    get_buffer_window_list = build_lisp_symbol("get-buffer-window-list")
    substitute_env_in_file_name = build_lisp_symbol("substitute-env-in-file-name")
    delete_directory = build_lisp_symbol("delete-directory")
    copy_directory = build_lisp_symbol("copy-directory")
    move_file_to_trash = build_lisp_symbol("move-file-to-trash")
    delete_by_moving_to_trash = build_lisp_symbol("delete-by-moving-to-trash")
    write_region_annotate_functions = build_lisp_symbol("write-region-annotate-functions")
    car_less_than_car = build_lisp_symbol("car-less-than-car")
    after_insert_file_set_coding = build_lisp_symbol("after-insert-file-set-coding")
    format_annotate_function = build_lisp_symbol("format-annotate-function")
    format_decode = build_lisp_symbol("format-decode")
    excl = build_lisp_symbol("excl")
    remote_file_error = build_lisp_symbol("remote-file-error")
    file_notify_error = build_lisp_symbol("file-notify-error")
    file_missing = build_lisp_symbol("file-missing")
    file_date_error = build_lisp_symbol("file-date-error")
    file_already_exists = build_lisp_symbol("file-already-exists")
    file_name_history = build_lisp_symbol("file-name-history")
    auto_save_coding = build_lisp_symbol("auto-save-coding")
    file_system_info = build_lisp_symbol("file-system-info")
    set_visited_file_modtime = build_lisp_symbol("set-visited-file-modtime")
    verify_visited_file_modtime = build_lisp_symbol("verify-visited-file-modtime")
    write_region = build_lisp_symbol("write-region")
    insert_file_contents = build_lisp_symbol("insert-file-contents")
    file_newer_than_file_p = build_lisp_symbol("file-newer-than-file-p")
    set_file_acl = build_lisp_symbol("set-file-acl")
    file_acl = build_lisp_symbol("file-acl")
    set_file_selinux_context = build_lisp_symbol("set-file-selinux-context")
    file_selinux_context = build_lisp_symbol("file-selinux-context")
    set_file_times = build_lisp_symbol("set-file-times")
    set_file_modes = build_lisp_symbol("set-file-modes")
    file_modes = build_lisp_symbol("file-modes")
    file_accessible_directory_p = build_lisp_symbol("file-accessible-directory-p")
    file_regular_p = build_lisp_symbol("file-regular-p")
    file_directory_p = build_lisp_symbol("file-directory-p")
    access_file = build_lisp_symbol("access-file")
    file_symlink_p = build_lisp_symbol("file-symlink-p")
    file_writable_p = build_lisp_symbol("file-writable-p")
    file_readable_p = build_lisp_symbol("file-readable-p")
    file_executable_p = build_lisp_symbol("file-executable-p")
    file_exists_p = build_lisp_symbol("file-exists-p")
    make_symbolic_link = build_lisp_symbol("make-symbolic-link")
    add_name_to_file = build_lisp_symbol("add-name-to-file")
    rename_file = build_lisp_symbol("rename-file")
    file_name_case_insensitive_p = build_lisp_symbol("file-name-case-insensitive-p")
    delete_file = build_lisp_symbol("delete-file")
    make_directory = build_lisp_symbol("make-directory")
    make_directory_internal = build_lisp_symbol("make-directory-internal")
    copy_file = build_lisp_symbol("copy-file")
    file_name_as_directory = build_lisp_symbol("file-name-as-directory")
    unhandled_file_name_directory = build_lisp_symbol("unhandled-file-name-directory")
    file_name_nondirectory = build_lisp_symbol("file-name-nondirectory")
    file_name_directory = build_lisp_symbol("file-name-directory")
    directory_file_name = build_lisp_symbol("directory-file-name")
    substitute_in_file_name = build_lisp_symbol("substitute-in-file-name")
    expand_file_name = build_lisp_symbol("expand-file-name")
    operations = build_lisp_symbol("operations")
...
def syms_of_fileio():
    ...
    DEFSYM(Q.operations, "operations")
    #
    #   DEFSYM (Qexpand_file_name, "expand-file-name");
    DEFSYM(Q.expand_file_name, "expand-file-name")
    #   DEFSYM (Qsubstitute_in_file_name, "substitute-in-file-name");
    DEFSYM(Q.substitute_in_file_name, "substitute-in-file-name")
    #   DEFSYM (Qdirectory_file_name, "directory-file-name");
    DEFSYM(Q.directory_file_name, "directory-file-name")
    #   DEFSYM (Qfile_name_directory, "file-name-directory");
    DEFSYM(Q.file_name_directory, "file-name-directory")
    #   DEFSYM (Qfile_name_nondirectory, "file-name-nondirectory");
    DEFSYM(Q.file_name_nondirectory, "file-name-nondirectory")
    #   DEFSYM (Qunhandled_file_name_directory, "unhandled-file-name-directory");
    DEFSYM(Q.unhandled_file_name_directory, "unhandled-file-name-directory")
    #   DEFSYM (Qfile_name_as_directory, "file-name-as-directory");
    DEFSYM(Q.file_name_as_directory, "file-name-as-directory")
    #   DEFSYM (Qcopy_file, "copy-file");
    DEFSYM(Q.copy_file, "copy-file")
    #   DEFSYM (Qmake_directory_internal, "make-directory-internal");
    DEFSYM(Q.make_directory_internal, "make-directory-internal")
    #   DEFSYM (Qmake_directory, "make-directory");
    DEFSYM(Q.make_directory, "make-directory")
    #   DEFSYM (Qdelete_file, "delete-file");
    DEFSYM(Q.delete_file, "delete-file")
    #   DEFSYM (Qfile_name_case_insensitive_p, "file-name-case-insensitive-p");
    DEFSYM(Q.file_name_case_insensitive_p, "file-name-case-insensitive-p")
    #   DEFSYM (Qrename_file, "rename-file");
    DEFSYM(Q.rename_file, "rename-file")
    #   DEFSYM (Qadd_name_to_file, "add-name-to-file");
    DEFSYM(Q.add_name_to_file, "add-name-to-file")
    #   DEFSYM (Qmake_symbolic_link, "make-symbolic-link");
    DEFSYM(Q.make_symbolic_link, "make-symbolic-link")
    #   DEFSYM (Qfile_exists_p, "file-exists-p");
    DEFSYM(Q.file_exists_p, "file-exists-p")
    #   DEFSYM (Qfile_executable_p, "file-executable-p");
    DEFSYM(Q.file_executable_p, "file-executable-p")
    #   DEFSYM (Qfile_readable_p, "file-readable-p");
    DEFSYM(Q.file_readable_p, "file-readable-p")
    #   DEFSYM (Qfile_writable_p, "file-writable-p");
    DEFSYM(Q.file_writable_p, "file-writable-p")
    #   DEFSYM (Qfile_symlink_p, "file-symlink-p");
    DEFSYM(Q.file_symlink_p, "file-symlink-p")
    #   DEFSYM (Qaccess_file, "access-file");
    DEFSYM(Q.access_file, "access-file")
    #   DEFSYM (Qfile_directory_p, "file-directory-p");
    DEFSYM(Q.file_directory_p, "file-directory-p")
    #   DEFSYM (Qfile_regular_p, "file-regular-p");
    DEFSYM(Q.file_regular_p, "file-regular-p")
    #   DEFSYM (Qfile_accessible_directory_p, "file-accessible-directory-p");
    DEFSYM(Q.file_accessible_directory_p, "file-accessible-directory-p")
    #   DEFSYM (Qfile_modes, "file-modes");
    DEFSYM(Q.file_modes, "file-modes")
    #   DEFSYM (Qset_file_modes, "set-file-modes");
    DEFSYM(Q.set_file_modes, "set-file-modes")
    #   DEFSYM (Qset_file_times, "set-file-times");
    DEFSYM(Q.set_file_times, "set-file-times")
    #   DEFSYM (Qfile_selinux_context, "file-selinux-context");
    DEFSYM(Q.file_selinux_context, "file-selinux-context")
    #   DEFSYM (Qset_file_selinux_context, "set-file-selinux-context");
    DEFSYM(Q.set_file_selinux_context, "set-file-selinux-context")
    #   DEFSYM (Qfile_acl, "file-acl");
    DEFSYM(Q.file_acl, "file-acl")
    #   DEFSYM (Qset_file_acl, "set-file-acl");
    DEFSYM(Q.set_file_acl, "set-file-acl")
    #   DEFSYM (Qfile_newer_than_file_p, "file-newer-than-file-p");
    DEFSYM(Q.file_newer_than_file_p, "file-newer-than-file-p")
    #   DEFSYM (Qinsert_file_contents, "insert-file-contents");
    DEFSYM(Q.insert_file_contents, "insert-file-contents")
    #   DEFSYM (Qwrite_region, "write-region");
    DEFSYM(Q.write_region, "write-region")
    #   DEFSYM (Qverify_visited_file_modtime, "verify-visited-file-modtime");
    DEFSYM(Q.verify_visited_file_modtime, "verify-visited-file-modtime")
    #   DEFSYM (Qset_visited_file_modtime, "set-visited-file-modtime");
    DEFSYM(Q.set_visited_file_modtime, "set-visited-file-modtime")
    #   DEFSYM (Qfile_system_info, "file-system-info");
    DEFSYM(Q.file_system_info, "file-system-info")
    #
    ...
    DEFSYM(Q.auto_save_coding, "auto-save-coding")
    #
    #   DEFSYM (Qfile_name_history, "file-name-history");
    DEFSYM(Q.file_name_history, "file-name-history")
    #   Fset (Qfile_name_history, Qnil);
    #
    #   DEFSYM (Qfile_error, "file-error");
    DEFSYM(Q.file_error, "file-error")
    #   DEFSYM (Qfile_already_exists, "file-already-exists");
    DEFSYM(Q.file_already_exists, "file-already-exists")
    #   DEFSYM (Qfile_date_error, "file-date-error");
    DEFSYM(Q.file_date_error, "file-date-error")
    #   DEFSYM (Qfile_missing, "file-missing");
    DEFSYM(Q.file_missing, "file-missing")
    #   DEFSYM (Qfile_notify_error, "file-notify-error");
    DEFSYM(Q.file_notify_error, "file-notify-error")
    #   DEFSYM (Qremote_file_error, "remote-file-error");
    DEFSYM(Q.remote_file_error, "remote-file-error")
    #   DEFSYM (Qexcl, "excl");
    DEFSYM(Q.excl, "excl")
    #
    ...
    DEFSYM(Q.format_decode, "format-decode")
    #   DEFSYM (Qformat_annotate_function, "format-annotate-function");
    DEFSYM(Q.format_annotate_function, "format-annotate-function")
    #
    ...
    DEFSYM(Q.after_insert_file_set_coding, "after-insert-file-set-coding")
    #
    #   DEFSYM (Qcar_less_than_car, "car-less-than-car");
    DEFSYM(Q.car_less_than_car, "car-less-than-car")
    #
    ...
    DEFSYM(Q.write_region_annotate_functions, "write-region-annotate-functions")
    #
    ...
    DEFSYM(Q.delete_by_moving_to_trash, "delete-by-moving-to-trash")
    #
    #   /* Lisp function for moving files to trash.  */
    #   DEFSYM (Qmove_file_to_trash, "move-file-to-trash");
    DEFSYM(Q.move_file_to_trash, "move-file-to-trash")
    #
    #   /* Lisp function for recursively copying directories.  */
    #   DEFSYM (Qcopy_directory, "copy-directory");
    DEFSYM(Q.copy_directory, "copy-directory")
    #
    #   /* Lisp function for recursively deleting directories.  */
    #   DEFSYM (Qdelete_directory, "delete-directory");
    DEFSYM(Q.delete_directory, "delete-directory")
    #
    #   DEFSYM (Qsubstitute_env_in_file_name, "substitute-env-in-file-name");
    DEFSYM(Q.substitute_env_in_file_name, "substitute-env-in-file-name")
    #   DEFSYM (Qget_buffer_window_list, "get-buffer-window-list");
    DEFSYM(Q.get_buffer_window_list, "get-buffer-window-list")
    #
    #   DEFSYM (Qstdin, "stdin");
    DEFSYM(Q.stdin, "stdin")
    #   DEFSYM (Qstdout, "stdout");
    DEFSYM(Q.stdout, "stdout")
    #   DEFSYM (Qstderr, "stderr");
    DEFSYM(Q.stderr, "stderr")
    #
    #   defsubr (&Sfind_file_name_handler);
    defsubr(S.find_file_name_handler)
    #   defsubr (&Sfile_name_directory);
    defsubr(S.file_name_directory)
    #   defsubr (&Sfile_name_nondirectory);
    defsubr(S.file_name_nondirectory)
    #   defsubr (&Sunhandled_file_name_directory);
    defsubr(S.unhandled_file_name_directory)
    #   defsubr (&Sfile_name_as_directory);
    defsubr(S.file_name_as_directory)
    #   defsubr (&Sdirectory_name_p);
    defsubr(S.directory_name_p)
    #   defsubr (&Sdirectory_file_name);
    defsubr(S.directory_file_name)
    #   defsubr (&Smake_temp_file_internal);
    defsubr(S.make_temp_file_internal)
    #   defsubr (&Smake_temp_name);
    defsubr(S.make_temp_name)
    #   defsubr (&Sfile_name_concat);
    defsubr(S.file_name_concat)
    #   defsubr (&Sexpand_file_name);
    defsubr(S.expand_file_name)
    #   defsubr (&Ssubstitute_in_file_name);
    defsubr(S.substitute_in_file_name)
    #   defsubr (&Scopy_file);
    defsubr(S.copy_file)
    #   defsubr (&Smake_directory_internal);
    defsubr(S.make_directory_internal)
    #   defsubr (&Sdelete_directory_internal);
    defsubr(S.delete_directory_internal)
    #   defsubr (&Sdelete_file);
    defsubr(S.delete_file)
    #   defsubr (&Sfile_name_case_insensitive_p);
    defsubr(S.file_name_case_insensitive_p)
    #   defsubr (&Srename_file);
    defsubr(S.rename_file)
    #   defsubr (&Sadd_name_to_file);
    defsubr(S.add_name_to_file)
    #   defsubr (&Smake_symbolic_link);
    defsubr(S.make_symbolic_link)
    #   defsubr (&Sfile_name_absolute_p);
    defsubr(S.file_name_absolute_p)
    #   defsubr (&Sfile_exists_p);
    defsubr(S.file_exists_p)
    #   defsubr (&Sfile_executable_p);
    defsubr(S.file_executable_p)
    #   defsubr (&Sfile_readable_p);
    defsubr(S.file_readable_p)
    #   defsubr (&Sfile_writable_p);
    defsubr(S.file_writable_p)
    #   defsubr (&Saccess_file);
    defsubr(S.access_file)
    #   defsubr (&Sfile_symlink_p);
    defsubr(S.file_symlink_p)
    #   defsubr (&Sfile_directory_p);
    defsubr(S.file_directory_p)
    #   defsubr (&Sfile_accessible_directory_p);
    defsubr(S.file_accessible_directory_p)
    #   defsubr (&Sfile_regular_p);
    defsubr(S.file_regular_p)
    #   defsubr (&Sfile_modes);
    defsubr(S.file_modes)
    #   defsubr (&Sset_file_modes);
    defsubr(S.set_file_modes)
    #   defsubr (&Sset_file_times);
    defsubr(S.set_file_times)
    #   defsubr (&Sfile_selinux_context);
    defsubr(S.file_selinux_context)
    #   defsubr (&Sfile_acl);
    defsubr(S.file_acl)
    #   defsubr (&Sset_file_acl);
    defsubr(S.set_file_acl)
    #   defsubr (&Sset_file_selinux_context);
    defsubr(S.set_file_selinux_context)
    #   defsubr (&Sset_default_file_modes);
    defsubr(S.set_default_file_modes)
    #   defsubr (&Sdefault_file_modes);
    defsubr(S.default_file_modes)
    #   defsubr (&Sfile_newer_than_file_p);
    defsubr(S.file_newer_than_file_p)
    #   defsubr (&Sinsert_file_contents);
    defsubr(S.insert_file_contents)
    #   defsubr (&Swrite_region);
    defsubr(S.write_region)
    #   defsubr (&Scar_less_than_car);
    defsubr(S.car_less_than_car)
    #   defsubr (&Sverify_visited_file_modtime);
    defsubr(S.verify_visited_file_modtime)
    #   defsubr (&Svisited_file_modtime);
    defsubr(S.visited_file_modtime)
    #   defsubr (&Sset_visited_file_modtime);
    defsubr(S.set_visited_file_modtime)
    #   defsubr (&Sdo_auto_save);
    defsubr(S.do_auto_save)
    #   defsubr (&Sset_buffer_auto_saved);
    defsubr(S.set_buffer_auto_saved)
    #   defsubr (&Sclear_buffer_auto_save_failure);
    defsubr(S.clear_buffer_auto_save_failure)
    #   defsubr (&Srecent_auto_save_p);
    defsubr(S.recent_auto_save_p)
    #
    #   defsubr (&Snext_read_file_uses_dialog_p);
    defsubr(S.next_read_file_uses_dialog_p)
    #
    #   defsubr (&Sset_binary_mode);
    defsubr(S.set_binary_mode)
    #
    # #ifndef DOS_NT
    #   defsubr (&Sfile_system_info);
    defsubr(S.file_system_info)
    # #endif
    #
    # #ifdef HAVE_SYNC
    #   defsubr (&Sunix_sync);
