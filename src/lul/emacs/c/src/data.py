...
# }
def wrong_type_argument(predicate: Lisp_Object, value: Lisp_Object):
...
# }
def args_out_of_range(a1: Lisp_Object, a2: Lisp_Object):
    return xsignal2(Q.args_out_of_range, a1, a2)
#
# void
...
# }
def args_out_of_range_3(a1: Lisp_Object, a2: Lisp_Object, a3: Lisp_Object):
    return xsignal3(Q.args_out_of_range, a1, a2, a3)
#
# void
...
# }
def circular_list(list: Lisp_Object):
    return xsignal1(Q.circular_list, list)
#
@mixin(F)
class F:
    # 
    ...
    @DEFUN("eq", S.eq, 2, 2, 0)
    @staticmethod
    def eq(obj1: Lisp_Object, obj2: Lisp_Object):
        #   if (EQ (obj1, obj2))
        #     return Qt;
        if EQ(obj1, obj2):
            return Q.t
    ...
    #   (Lisp_Object object)
    # {
    @DEFUN("null", S.null, 1, 1, 0)
    @staticmethod
    def null(object: Lisp_Object):
        #   if (NILP (object))
        #     return Qt;
        if NILP(object):
            return Q.t
    ...
    #   (Lisp_Object object)
    # {
    @DEFUN("consp", S.consp, 1, 1, 0)
    @staticmethod
    def consp(object: Lisp_Object):
        #   if (CONSP (object))
        #     return Qt;
        if CONSP(object):
            return Q.t
    ...
    #   (Lisp_Object object)
    # {
    @DEFUN("atom", S.atom, 1, 1, 0)
    @staticmethod
    def atom(object: Lisp_Object):
        #   if (CONSP (object))
        #     return Qnil;
        if CONSP(object):
            return Q.nil
    ...
    #   (Lisp_Object object)
    # {
    @DEFUN("listp", S.listp, 1, 1, 0)
    @staticmethod
    def listp(object: Lisp_Object):
        #   if (CONSP (object) || NILP (object))
        #     return Qt;
        if CONSP(object) or NILP(object):
            return Q.t
        #   return Qnil;
        return Q.nil
    # }
    ...
    #   (Lisp_Object object)
    # {
    @DEFUN("symbolp", S.symbolp, 1, 1, 0)
    @staticmethod
    def symbolp(object: Lisp_Object):
        #   if (SYMBOLP (object))
        #     return Qt;
        #   return Qnil;
        if SYMBOLP(object):
    ...
    #   return CAR (list);
    # }
    @DEFUN("car", S.car, 1, 1, 0)
    @staticmethod
    def car(list: Lisp_Object):
        return CAR(list)
    #
    ...
    # }
    @DEFUN("car-safe", S.car_safe, 1, 1, 0)
    @staticmethod
    def car_safe(list: Lisp_Object):
    ...
    #   return CDR (list);
    # }
    @DEFUN("cdr", S.cdr, 1, 1, 0)
    @staticmethod
    def cdr(list: Lisp_Object):
        return CDR(list)
    #
    ...
    # }
    @DEFUN("cdr-safe", S.cdr_safe, 1, 1, 0)
    @staticmethod
    def cdr_safe(list: Lisp_Object):
        return CDR_SAFE(list)
    #
    ...
    #   return newcar;
    # }
    @DEFUN("setcar", S.setcar, 2, 2, 0)
    @staticmethod
    def setcar(cell: Lisp_Object, newcar: Lisp_Object):
        CHECK_CONS(cell)
        CHECK_IMPURE(cell, XCONS(cell))
        XSETCAR(cell, newcar)
        return newcar
    ...
    #   return newcdr;
    # }
    @DEFUN("setcdr", S.setcdr, 2, 2, 0)
    @staticmethod
    def setcdr(cell: Lisp_Object, newcdr: Lisp_Object):
        CHECK_CONS(cell)
        CHECK_IMPURE(cell, XCONS(cell))
        XSETCDR(cell, newcdr)
        return newcdr
...
# {
def indirect_variable(symbol: Lisp_Symbol):
    ...
    while hare.u.s.redirect == SYMBOL_VARALIAS:
        ...
        if hare == tortoise:
            ...
            tem = XSETSYMBOL(symbol)
            # xsignal1 (Qcyclic_variable_indirection, tem);
            xsignal1(Q.cyclic_variable_indirection, tem)
        #   }
    #   }
    #
    # return hare;
...
# {
def find_symbol_value(symbol: Lisp_Object):
    # struct Lisp_Symbol *sym;
    #
    # CHECK_SYMBOL (symbol);
    CHECK_SYMBOL(symbol)
    ...
    #start:
    while True:
        redirect = sym.u.s.redirect
        # switch (sym->u.s.redirect)
        #   {
        #   case SYMBOL_VARALIAS: sym = indirect_variable (sym); goto start;
        if redirect == SYMBOL_VARALIAS:
            sym = indirect_variable(sym)
            continue
        #   case SYMBOL_PLAINVAL: return SYMBOL_VAL (sym);
        if redirect == SYMBOL_PLAINVAL:
        ...
        if redirect == SYMBOL_LOCALIZED:
            ...
            #         : blv_value (blv));
            raise NotImplementedError("find_symbol_value SYMBOL_LOCALIZED")
        #     }
        #   case SYMBOL_FORWARDED:
...
class F:
    ...
    #   (Lisp_Object symbol)
    # {
    @DEFUN("symbol-value", S.symbol_value, 1, 1, 0)
    @staticmethod
    def symbol_value(symbol: Lisp_Object):
        # Lisp_Object val;
        #
        ...
        # if (!EQ (val, Qunbound))
        #   return val;
        if not EQ(val, Q.unbound):
            return val
        #
        # xsignal1 (Qvoid_variable, symbol);
        return xsignal1(Q.void_variable, symbol)
    # }
#
...
# {
def indirect_function(object: Lisp_Object):
    ...
    while True:
        ...
        #    break;
        if not SYMBOLP(hare) or NILP(hare):
            break
        ...
        if EQ(hare, tortoise):
            xsignal1(Q.cyclic_function_indirection, object)
    #   }
    #
    # return hare;
    return hare
...
@mixin(Q)
class Q:
    quote = build_lisp_symbol("quote")
    lambda_ = build_lisp_symbol("lambda")
    error_conditions = build_lisp_symbol("error-conditions")
    error_message = build_lisp_symbol("error-message")
    top_level = build_lisp_symbol("top-level")
    #
    error = build_lisp_symbol("error")
    user_error = build_lisp_symbol("user-error")
    quit = build_lisp_symbol("quit")
    minibuffer_quit = build_lisp_symbol("minibuffer-quit")
    wrong_length_argument = build_lisp_symbol("wrong-length-argument")
    wrong_type_argument = build_lisp_symbol("wrong-type-argument")
    args_out_of_range = build_lisp_symbol("args-out-of-range")
    void_function = build_lisp_symbol("void-function")
    cyclic_function_indirection = build_lisp_symbol("cyclic-function-indirection")
    cyclic_variable_indirection = build_lisp_symbol("cyclic-variable-indirection")
    void_variable = build_lisp_symbol("void-variable")
    setting_constant = build_lisp_symbol("setting-constant")
    trapping_constant = build_lisp_symbol("trapping-constant")
    invalid_read_syntax = build_lisp_symbol("invalid-read-syntax")
    #
    invalid_function = build_lisp_symbol("invalid-function")
    wrong_number_of_arguments = build_lisp_symbol("wrong-number-of-arguments")
    no_catch = build_lisp_symbol("no-catch")
    end_of_file = build_lisp_symbol("end-of-file")
    arith_error = build_lisp_symbol("arith-error")
    beginning_of_buffer = build_lisp_symbol("beginning-of-buffer")
    end_of_buffer = build_lisp_symbol("end-of-buffer")
    buffer_read_only = build_lisp_symbol("buffer-read-only")
    text_read_only = build_lisp_symbol("text-read-only")
    mark_inactive = build_lisp_symbol("mark-inactive")
    inhibited_interaction = build_lisp_symbol("inhibited-interaction")
    #
    listp = build_lisp_symbol("listp");
    consp = build_lisp_symbol("consp")
    symbolp = build_lisp_symbol("symbolp")
    fixnump = build_lisp_symbol("fixnump")
    integerp = build_lisp_symbol("integerp")
    natnump = build_lisp_symbol("natnump")
    wholenump = build_lisp_symbol("wholenump")
    stringp = build_lisp_symbol("stringp")
    arrayp = build_lisp_symbol("arrayp")
    sequencep = build_lisp_symbol("sequencep")
    bufferp = build_lisp_symbol("bufferp")
    vectorp = build_lisp_symbol("vectorp")
    recordp = build_lisp_symbol("recordp")
    bool_vector_p = build_lisp_symbol("bool-vector-p")
    char_or_string_p = build_lisp_symbol("char-or-string-p")
    markerp = build_lisp_symbol("markerp")
    user_ptrp = build_lisp_symbol("user-ptrp")
    buffer_or_string_p = build_lisp_symbol("buffer-or-string-p")
    integer_or_marker_p = build_lisp_symbol("integer-or-marker-p")
    fboundp = build_lisp_symbol("fboundp")
    #
    floatp = build_lisp_symbol("floatp")
    numberp = build_lisp_symbol("numberp")
    number_or_marker_p = build_lisp_symbol("number-or-marker-p")
    #
    char_table_p = build_lisp_symbol("char-table-p")
    vector_or_char_table_p = build_lisp_symbol("vector-or-char-table-p")
    #
    subrp = build_lisp_symbol("subrp");
    unevalled = build_lisp_symbol("unevalled")
    many = build_lisp_symbol("many")
    #
    cdr = build_lisp_symbol("cdr")
    #
    circular_list = build_lisp_symbol("circular-list")
    #
    range_error = build_lisp_symbol("range-error")
    domain_error = build_lisp_symbol("domain-error")
    singularity_error = build_lisp_symbol("singularity-error")
    overflow_error = build_lisp_symbol("overflow-error")
    underflow_error = build_lisp_symbol("underflow-error")
    #
    #   /* Types that type-of returns.  */
    integer = build_lisp_symbol("integer")
    symbol = build_lisp_symbol("symbol")
    string = build_lisp_symbol("string")
    cons = build_lisp_symbol("cons")
    marker = build_lisp_symbol("marker")
    overlay = build_lisp_symbol("overlay")
    finalizer = build_lisp_symbol("finalizer")
    module_function = build_lisp_symbol("module-function")
    native_comp_unit = build_lisp_symbol("native-comp-unit")
    user_ptr = build_lisp_symbol("user-ptr")
    float = build_lisp_symbol("float")
    window_configuration = build_lisp_symbol("window-configuration")
    process = build_lisp_symbol("process")
    window = build_lisp_symbol("window")
    subr = build_lisp_symbol("subr")
    compiled_function = build_lisp_symbol("compiled-function")
    buffer = build_lisp_symbol("buffer")
    frame = build_lisp_symbol("frame")
    vector = build_lisp_symbol("vector")
    record = build_lisp_symbol("record")
    char_table = build_lisp_symbol("char-table")
    bool_vector = build_lisp_symbol("bool-vector")
    hash_table = build_lisp_symbol("hash-table")
    thread = build_lisp_symbol("thread")
    mutex = build_lisp_symbol("mutex")
    condition_variable = build_lisp_symbol("condition-variable")
    font_spec = build_lisp_symbol("font-spec")
    font_entity = build_lisp_symbol("font-entity")
    font_object = build_lisp_symbol("font-object")
    terminal = build_lisp_symbol("terminal")
    xwidget = build_lisp_symbol("xwidget")
    xwidget_view = build_lisp_symbol("xwidget-view")
    #
    defun = build_lisp_symbol("defun")
    #
    interactive_form = build_lisp_symbol("interactive-form")
    defalias_fset_function = build_lisp_symbol("defalias-fset-function")
    #
    byte_code_function_p = build_lisp_symbol("byte-code-function-p")
    #
    watchers = build_lisp_symbol("watchers")
    makunbound = build_lisp_symbol("makunbound")
    unlet = build_lisp_symbol("unlet")
    set = build_lisp_symbol("set")
    set_default = build_lisp_symbol("set-default")
    command_modes = build_lisp_symbol("command-modes")
...
def syms_of_data():
    ...
    #
    #   DEFSYM (Qquote, "quote");
    DEFSYM(Q.quote, "quote")
    #   DEFSYM (Qlambda, "lambda");
    DEFSYM(Q.lambda_, "lambda")
    #   DEFSYM (Qerror_conditions, "error-conditions");
    DEFSYM(Q.error_conditions, "error-conditions")
    #   DEFSYM (Qerror_message, "error-message");
    DEFSYM(Q.error_message, "error-message")
    #   DEFSYM (Qtop_level, "top-level");
    DEFSYM(Q.top_level, "top-level")
    #
    #   DEFSYM (Qerror, "error");
    DEFSYM(Q.error, "error")
    #   DEFSYM (Quser_error, "user-error");
    DEFSYM(Q.user_error, "user-error")
    #   DEFSYM (Qquit, "quit");
    DEFSYM(Q.quit, "quit")
    #   DEFSYM (Qminibuffer_quit, "minibuffer-quit");
    DEFSYM(Q.minibuffer_quit, "minibuffer-quit")
    #   DEFSYM (Qwrong_length_argument, "wrong-length-argument");
    DEFSYM(Q.wrong_length_argument, "wrong-length-argument")
    #   DEFSYM (Qwrong_type_argument, "wrong-type-argument");
    DEFSYM(Q.wrong_type_argument, "wrong-type-argument")
    #   DEFSYM (Qargs_out_of_range, "args-out-of-range");
    DEFSYM(Q.args_out_of_range, "args-out-of-range")
    #   DEFSYM (Qvoid_function, "void-function");
    DEFSYM(Q.void_function, "void-function")
    #   DEFSYM (Qcyclic_function_indirection, "cyclic-function-indirection");
    DEFSYM(Q.cyclic_function_indirection, "cyclic-function-indirection")
    #   DEFSYM (Qcyclic_variable_indirection, "cyclic-variable-indirection");
    DEFSYM(Q.cyclic_variable_indirection, "cyclic-variable-indirection")
    #   DEFSYM (Qvoid_variable, "void-variable");
    DEFSYM(Q.void_variable, "void-variable")
    #   DEFSYM (Qsetting_constant, "setting-constant");
    DEFSYM(Q.setting_constant, "setting-constant")
    #   DEFSYM (Qtrapping_constant, "trapping-constant");
    DEFSYM(Q.trapping_constant, "trapping-constant")
    #   DEFSYM (Qinvalid_read_syntax, "invalid-read-syntax");
    DEFSYM(Q.invalid_read_syntax, "invalid-read-syntax")
    #
    #   DEFSYM (Qinvalid_function, "invalid-function");
    DEFSYM(Q.invalid_function, "invalid-function")
    #   DEFSYM (Qwrong_number_of_arguments, "wrong-number-of-arguments");
    DEFSYM(Q.wrong_number_of_arguments, "wrong-number-of-arguments")
    #   DEFSYM (Qno_catch, "no-catch");
    DEFSYM(Q.no_catch, "no-catch")
    #   DEFSYM (Qend_of_file, "end-of-file");
    DEFSYM(Q.end_of_file, "end-of-file")
    #   DEFSYM (Qarith_error, "arith-error");
    DEFSYM(Q.arith_error, "arith-error")
    #   DEFSYM (Qbeginning_of_buffer, "beginning-of-buffer");
    DEFSYM(Q.beginning_of_buffer, "beginning-of-buffer")
    #   DEFSYM (Qend_of_buffer, "end-of-buffer");
    DEFSYM(Q.end_of_buffer, "end-of-buffer")
    #   DEFSYM (Qbuffer_read_only, "buffer-read-only");
    DEFSYM(Q.buffer_read_only, "buffer-read-only")
    #   DEFSYM (Qtext_read_only, "text-read-only");
    DEFSYM(Q.text_read_only, "text-read-only")
    #   DEFSYM (Qmark_inactive, "mark-inactive");
    DEFSYM(Q.mark_inactive, "mark-inactive")
    #   DEFSYM (Qinhibited_interaction, "inhibited-interaction");
    DEFSYM(Q.inhibited_interaction, "inhibited-interaction")
    #
    #   DEFSYM (Qlistp, "listp");
    DEFSYM (Q.listp, "listp");
    #   DEFSYM (Qconsp, "consp");
    DEFSYM(Q.consp, "consp")
    #   DEFSYM (Qsymbolp, "symbolp");
    DEFSYM(Q.symbolp, "symbolp")
    #   DEFSYM (Qfixnump, "fixnump");
    DEFSYM(Q.fixnump, "fixnump")
    #   DEFSYM (Qintegerp, "integerp");
    DEFSYM(Q.integerp, "integerp")
    #   DEFSYM (Qnatnump, "natnump");
    DEFSYM(Q.natnump, "natnump")
    #   DEFSYM (Qwholenump, "wholenump");
    DEFSYM(Q.wholenump, "wholenump")
    #   DEFSYM (Qstringp, "stringp");
    DEFSYM(Q.stringp, "stringp")
    #   DEFSYM (Qarrayp, "arrayp");
    DEFSYM(Q.arrayp, "arrayp")
    #   DEFSYM (Qsequencep, "sequencep");
    DEFSYM(Q.sequencep, "sequencep")
    #   DEFSYM (Qbufferp, "bufferp");
    DEFSYM(Q.bufferp, "bufferp")
    #   DEFSYM (Qvectorp, "vectorp");
    DEFSYM(Q.vectorp, "vectorp")
    #   DEFSYM (Qrecordp, "recordp");
    DEFSYM(Q.recordp, "recordp")
    #   DEFSYM (Qbool_vector_p, "bool-vector-p");
    DEFSYM(Q.bool_vector_p, "bool-vector-p")
    #   DEFSYM (Qchar_or_string_p, "char-or-string-p");
    DEFSYM(Q.char_or_string_p, "char-or-string-p")
    #   DEFSYM (Qmarkerp, "markerp");
    DEFSYM(Q.markerp, "markerp")
    #   DEFSYM (Quser_ptrp, "user-ptrp");
    DEFSYM(Q.user_ptrp, "user-ptrp")
    #   DEFSYM (Qbuffer_or_string_p, "buffer-or-string-p");
    DEFSYM(Q.buffer_or_string_p, "buffer-or-string-p")
    #   DEFSYM (Qinteger_or_marker_p, "integer-or-marker-p");
    DEFSYM(Q.integer_or_marker_p, "integer-or-marker-p")
    #   DEFSYM (Qfboundp, "fboundp");
    DEFSYM(Q.fboundp, "fboundp")
    #
    #   DEFSYM (Qfloatp, "floatp");
    DEFSYM(Q.floatp, "floatp")
    #   DEFSYM (Qnumberp, "numberp");
    DEFSYM(Q.numberp, "numberp")
    #   DEFSYM (Qnumber_or_marker_p, "number-or-marker-p");
    DEFSYM(Q.number_or_marker_p, "number-or-marker-p")
    #
    #   DEFSYM (Qchar_table_p, "char-table-p");
    DEFSYM(Q.char_table_p, "char-table-p")
    #   DEFSYM (Qvector_or_char_table_p, "vector-or-char-table-p");
    DEFSYM(Q.vector_or_char_table_p, "vector-or-char-table-p")
    #
    #   DEFSYM (Qsubrp, "subrp");
    DEFSYM (Q.subrp, "subrp");
    #   DEFSYM (Qunevalled, "unevalled");
    DEFSYM(Q.unevalled, "unevalled")
    #   DEFSYM (Qmany, "many");
    DEFSYM(Q.many, "many")
    #
    #   DEFSYM (Qcdr, "cdr");
    ...
    DEFSYM(Q.range_error, "range-error")
    DEFSYM(Q.domain_error, "domain-error")
    DEFSYM(Q.singularity_error, "singularity-error")
    DEFSYM(Q.overflow_error, "overflow-error")
    DEFSYM(Q.underflow_error, "underflow-error")
    #
    ...
    DEFSYM(Q.integer, "integer")
    DEFSYM(Q.symbol, "symbol")
    DEFSYM(Q.string, "string")
    DEFSYM(Q.cons, "cons")
    DEFSYM(Q.marker, "marker")
    DEFSYM(Q.overlay, "overlay")
    DEFSYM(Q.finalizer, "finalizer")
    DEFSYM(Q.module_function, "module-function")
    DEFSYM(Q.native_comp_unit, "native-comp-unit")
    DEFSYM(Q.user_ptr, "user-ptr")
    DEFSYM(Q.float, "float")
    DEFSYM(Q.window_configuration, "window-configuration")
    DEFSYM(Q.process, "process")
    DEFSYM(Q.window, "window")
    DEFSYM(Q.subr, "subr")
    DEFSYM(Q.compiled_function, "compiled-function")
    DEFSYM(Q.buffer, "buffer")
    DEFSYM(Q.frame, "frame")
    DEFSYM(Q.vector, "vector")
    DEFSYM(Q.record, "record")
    DEFSYM(Q.char_table, "char-table")
    DEFSYM(Q.bool_vector, "bool-vector")
    DEFSYM(Q.hash_table, "hash-table")
    DEFSYM(Q.thread, "thread")
    DEFSYM(Q.mutex, "mutex")
    DEFSYM(Q.condition_variable, "condition-variable")
    DEFSYM(Q.font_spec, "font-spec")
    DEFSYM(Q.font_entity, "font-entity")
    DEFSYM(Q.font_object, "font-object")
    DEFSYM(Q.terminal, "terminal")
    DEFSYM(Q.xwidget, "xwidget")
    DEFSYM(Q.xwidget_view, "xwidget-view")
    #
    #   DEFSYM (Qdefun, "defun");
    DEFSYM(Q.defun, "defun")
    #
    #   DEFSYM (Qinteractive_form, "interactive-form");
    DEFSYM(Q.interactive_form, "interactive-form")
    #   DEFSYM (Qdefalias_fset_function, "defalias-fset-function");
    DEFSYM(Q.defalias_fset_function, "defalias-fset-function")
    #
    #   DEFSYM (Qbyte_code_function_p, "byte-code-function-p");
    DEFSYM(Q.byte_code_function_p, "byte-code-function-p")
    #
    #   defsubr (&Sindirect_variable);
    defsubr(S.indirect_variable)
    #   defsubr (&Sinteractive_form);
    defsubr(S.interactive_form)
    #   defsubr (&Scommand_modes);
    defsubr(S.command_modes)
    #   defsubr (&Seq);
    defsubr(S.eq)
    #   defsubr (&Snull);
    defsubr(S.null)
    ...
    defsubr(S.integer_or_marker_p)
    #   defsubr (&Snumberp);
    defsubr(S.numberp)
    #   defsubr (&Snumber_or_marker_p);
    defsubr(S.number_or_marker_p)
    #   defsubr (&Sfloatp);
    defsubr(S.floatp)
    #   defsubr (&Snatnump);
    defsubr(S.natnump)
    ...
    defsubr(S.multibyte_string_p)
    #   defsubr (&Svectorp);
    defsubr(S.vectorp)
    #   defsubr (&Srecordp);
    defsubr(S.recordp)
    #   defsubr (&Schar_table_p);
    defsubr(S.char_table_p)
    #   defsubr (&Svector_or_char_table_p);
    defsubr(S.vector_or_char_table_p)
    #   defsubr (&Sbool_vector_p);
    defsubr(S.bool_vector_p)
    #   defsubr (&Sarrayp);
    defsubr(S.arrayp)
    #   defsubr (&Ssequencep);
    defsubr(S.sequencep)
    ...
    defsubr(S.byte_code_function_p)
    #   defsubr (&Smodule_function_p);
    defsubr(S.module_function_p)
    #   defsubr (&Schar_or_string_p);
    defsubr(S.char_or_string_p)
    #   defsubr (&Sthreadp);
    defsubr(S.threadp)
    #   defsubr (&Smutexp);
    defsubr(S.mutexp)
    #   defsubr (&Scondition_variable_p);
    defsubr(S.condition_variable_p)
    #   defsubr (&Scar);
    defsubr(S.car)
    #   defsubr (&Scdr);
    defsubr(S.cdr)
    ...
    defsubr(S.symbol_function)
    #   defsubr (&Sindirect_function);
    defsubr(S.indirect_function)
    #   defsubr (&Ssymbol_plist);
    defsubr(S.symbol_plist)
    #   defsubr (&Ssymbol_name);
    defsubr(S.symbol_name)
    #   defsubr (&Smakunbound);
    defsubr(S.makunbound)
    #   defsubr (&Sfmakunbound);
    defsubr(S.fmakunbound)
    #   defsubr (&Sboundp);
    defsubr(S.boundp)
    #   defsubr (&Sfboundp);
    defsubr(S.fboundp)
    ...
    defsubr(S.symbol_value)
    #   defsubr (&Sset);
    defsubr(S.set)
    #   defsubr (&Sdefault_boundp);
    defsubr(S.default_boundp)
    #   defsubr (&Sdefault_value);
    defsubr(S.default_value)
    #   defsubr (&Sset_default);
    defsubr(S.set_default)
    #   defsubr (&Smake_variable_buffer_local);
    defsubr(S.make_variable_buffer_local)
    #   defsubr (&Smake_local_variable);
    defsubr(S.make_local_variable)
    #   defsubr (&Skill_local_variable);
    defsubr(S.kill_local_variable)
    #   defsubr (&Slocal_variable_p);
    defsubr(S.local_variable_p)
    #   defsubr (&Slocal_variable_if_set_p);
    defsubr(S.local_variable_if_set_p)
    #   defsubr (&Svariable_binding_locus);
    defsubr(S.variable_binding_locus)
    #   defsubr (&Saref);
    defsubr(S.aref)
    #   defsubr (&Saset);
    defsubr(S.aset)
    #   defsubr (&Snumber_to_string);
    defsubr(S.number_to_string)
    #   defsubr (&Sstring_to_number);
    defsubr(S.string_to_number)
    #   defsubr (&Seqlsign);
    defsubr(S.eqlsign)
    #   defsubr (&Slss);
    defsubr(S.lss)
    ...
    defsubr(S.byteorder)
    #   defsubr (&Ssubr_arity);
    defsubr(S.subr_arity)
    #   defsubr (&Ssubr_name);
    defsubr(S.subr_name)
    #   defsubr (&Ssubr_native_elisp_p);
    defsubr(S.subr_native_elisp_p)
    #   defsubr (&Ssubr_native_lambda_list);
    defsubr(S.subr_native_lambda_list)
    #   defsubr (&Ssubr_type);
    defsubr(S.subr_type)
    # #ifdef HAVE_NATIVE_COMP
    #   defsubr (&Ssubr_native_comp_unit);
    defsubr(S.subr_native_comp_unit)
    #   defsubr (&Snative_comp_unit_file);
    defsubr(S.native_comp_unit_file)
    #   defsubr (&Snative_comp_unit_set_file);
    defsubr(S.native_comp_unit_set_file)
    # #endif
    # #ifdef HAVE_MODULES
    #   defsubr (&Suser_ptrp);
    defsubr(S.user_ptrp)
    ...
    defsubr(S.bool_vector_exclusive_or)
    #   defsubr (&Sbool_vector_union);
    defsubr(S.bool_vector_union)
    #   defsubr (&Sbool_vector_intersection);
    defsubr(S.bool_vector_intersection)
    #   defsubr (&Sbool_vector_set_difference);
    defsubr(S.bool_vector_set_difference)
    #   defsubr (&Sbool_vector_not);
    defsubr(S.bool_vector_not)
    #   defsubr (&Sbool_vector_subsetp);
    defsubr(S.bool_vector_subsetp)
    #   defsubr (&Sbool_vector_count_consecutive);
    defsubr(S.bool_vector_count_consecutive)
    #   defsubr (&Sbool_vector_count_population);
    defsubr(S.bool_vector_count_population)
    #
    ...
    DEFSYM(Q.watchers, "watchers")
    #   DEFSYM (Qmakunbound, "makunbound");
    DEFSYM(Q.makunbound, "makunbound")
    #   DEFSYM (Qunlet, "unlet");
    DEFSYM(Q.unlet, "unlet")
    #   DEFSYM (Qset, "set");
    DEFSYM(Q.set, "set")
    #   DEFSYM (Qset_default, "set-default");
    DEFSYM(Q.set_default, "set-default")
    #   DEFSYM (Qcommand_modes, "command-modes");
    DEFSYM(Q.command_modes, "command-modes")
    #   defsubr (&Sadd_variable_watcher);
    defsubr(S.add_variable_watcher)
    #   defsubr (&Sremove_variable_watcher);
    defsubr(S.remove_variable_watcher)
    #   defsubr (&Sget_variable_watchers);
    defsubr(S.get_variable_watchers)
