...
@mixin(Q)
class Q:
    quote = Lisp_Symbol("quote")
    lambda_ = Lisp_Symbol("lambda")
    error_conditions = Lisp_Symbol("error-conditions")
    error_message = Lisp_Symbol("error-message")
    top_level = Lisp_Symbol("top-level")
    #
    error = Lisp_Symbol("error")
    user_error = Lisp_Symbol("user-error")
    quit = Lisp_Symbol("quit")
    minibuffer_quit = Lisp_Symbol("minibuffer-quit")
    wrong_length_argument = Lisp_Symbol("wrong-length-argument")
    wrong_type_argument = Lisp_Symbol("wrong-type-argument")
    args_out_of_range = Lisp_Symbol("args-out-of-range")
    void_function = Lisp_Symbol("void-function")
    cyclic_function_indirection = Lisp_Symbol("cyclic-function-indirection")
    cyclic_variable_indirection = Lisp_Symbol("cyclic-variable-indirection")
    void_variable = Lisp_Symbol("void-variable")
    setting_constant = Lisp_Symbol("setting-constant")
    trapping_constant = Lisp_Symbol("trapping-constant")
    invalid_read_syntax = Lisp_Symbol("invalid-read-syntax")
    #
    invalid_function = Lisp_Symbol("invalid-function")
    wrong_number_of_arguments = Lisp_Symbol("wrong-number-of-arguments")
    no_catch = Lisp_Symbol("no-catch")
    end_of_file = Lisp_Symbol("end-of-file")
    arith_error = Lisp_Symbol("arith-error")
    beginning_of_buffer = Lisp_Symbol("beginning-of-buffer")
    end_of_buffer = Lisp_Symbol("end-of-buffer")
    buffer_read_only = Lisp_Symbol("buffer-read-only")
    text_read_only = Lisp_Symbol("text-read-only")
    mark_inactive = Lisp_Symbol("mark-inactive")
    inhibited_interaction = Lisp_Symbol("inhibited-interaction")
    #
    listp = Lisp_Symbol("listp");
    consp = Lisp_Symbol("consp")
    symbolp = Lisp_Symbol("symbolp")
    fixnump = Lisp_Symbol("fixnump")
    integerp = Lisp_Symbol("integerp")
    natnump = Lisp_Symbol("natnump")
    wholenump = Lisp_Symbol("wholenump")
    stringp = Lisp_Symbol("stringp")
    arrayp = Lisp_Symbol("arrayp")
    sequencep = Lisp_Symbol("sequencep")
    bufferp = Lisp_Symbol("bufferp")
    vectorp = Lisp_Symbol("vectorp")
    recordp = Lisp_Symbol("recordp")
    bool_vector_p = Lisp_Symbol("bool-vector-p")
    char_or_string_p = Lisp_Symbol("char-or-string-p")
    markerp = Lisp_Symbol("markerp")
    user_ptrp = Lisp_Symbol("user-ptrp")
    buffer_or_string_p = Lisp_Symbol("buffer-or-string-p")
    integer_or_marker_p = Lisp_Symbol("integer-or-marker-p")
    fboundp = Lisp_Symbol("fboundp")
    #
    floatp = Lisp_Symbol("floatp")
    numberp = Lisp_Symbol("numberp")
    number_or_marker_p = Lisp_Symbol("number-or-marker-p")
    #
    char_table_p = Lisp_Symbol("char-table-p")
    vector_or_char_table_p = Lisp_Symbol("vector-or-char-table-p")
    #
    subrp = Lisp_Symbol("subrp");
    unevalled = Lisp_Symbol("unevalled")
    many = Lisp_Symbol("many")
    #
    cdr = Lisp_Symbol("cdr")
    #
    circular_list = Lisp_Symbol("circular-list")
    #
    range_error = Lisp_Symbol("range-error")
    domain_error = Lisp_Symbol("domain-error")
    singularity_error = Lisp_Symbol("singularity-error")
    overflow_error = Lisp_Symbol("overflow-error")
    underflow_error = Lisp_Symbol("underflow-error")
    #
    #   /* Types that type-of returns.  */
    integer = Lisp_Symbol("integer")
    symbol = Lisp_Symbol("symbol")
    string = Lisp_Symbol("string")
    cons = Lisp_Symbol("cons")
    marker = Lisp_Symbol("marker")
    overlay = Lisp_Symbol("overlay")
    finalizer = Lisp_Symbol("finalizer")
    module_function = Lisp_Symbol("module-function")
    native_comp_unit = Lisp_Symbol("native-comp-unit")
    user_ptr = Lisp_Symbol("user-ptr")
    float = Lisp_Symbol("float")
    window_configuration = Lisp_Symbol("window-configuration")
    process = Lisp_Symbol("process")
    window = Lisp_Symbol("window")
    subr = Lisp_Symbol("subr")
    compiled_function = Lisp_Symbol("compiled-function")
    buffer = Lisp_Symbol("buffer")
    frame = Lisp_Symbol("frame")
    vector = Lisp_Symbol("vector")
    record = Lisp_Symbol("record")
    char_table = Lisp_Symbol("char-table")
    bool_vector = Lisp_Symbol("bool-vector")
    hash_table = Lisp_Symbol("hash-table")
    thread = Lisp_Symbol("thread")
    mutex = Lisp_Symbol("mutex")
    condition_variable = Lisp_Symbol("condition-variable")
    font_spec = Lisp_Symbol("font-spec")
    font_entity = Lisp_Symbol("font-entity")
    font_object = Lisp_Symbol("font-object")
    terminal = Lisp_Symbol("terminal")
    xwidget = Lisp_Symbol("xwidget")
    xwidget_view = Lisp_Symbol("xwidget-view")
    #
    defun = Lisp_Symbol("defun")
    #
    interactive_form = Lisp_Symbol("interactive-form")
    defalias_fset_function = Lisp_Symbol("defalias-fset-function")
    #
    byte_code_function_p = Lisp_Symbol("byte-code-function-p")
    #
    watchers = Lisp_Symbol("watchers")
    makunbound = Lisp_Symbol("makunbound")
    unlet = Lisp_Symbol("unlet")
    set = Lisp_Symbol("set")
    set_default = Lisp_Symbol("set-default")
    command_modes = Lisp_Symbol("command-modes")
