...
class V:
    ...
    prin1_to_string_buffer: Lisp_Object = Q.nil
#
...
class F:
    ...
    # {
    @staticmethod
    def error_message_string(obj: Lisp_Object):
        ...
        if CONSP(obj) and EQ(XCAR(obj), Q.error) \
            and CONSP(XCDR(obj)) \
            and STRINGP(XCAR(XCDR(obj))) \
            and NILP(XCDR(XCDR(obj))):
            return XCAR(XCDR(obj))
        #
        #   print_error_message (obj, Vprin1_to_string_buffer, 0, Qnil);
        print_error_message (obj, V.prin1_to_string_buffer, NULL, Q.nil)
        #
        #   set_buffer_internal (XBUFFER (Vprin1_to_string_buffer));
...
#                      Lisp_Object caller)
# {
def print_error_message(data: Lisp_Object, stream: Lisp_Object, context: Optional[str], caller: Lisp_Object):
