...
# {
def offset_intervals(buffer: buffer, start: ptrdiff_t, length: ptrdiff_t):
    print("TODO: offset_intervals")
...
# {
def set_point_both(charpos: ptrdiff_t, bytepos: ptrdiff_t):
    print("TODO: set_point_both")
