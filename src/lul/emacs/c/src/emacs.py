...
def syms_of_emacs():
    ...
    DEFSYM(Q.file_name_handler_alist, "file-name-handler-alist")
    DEFSYM(Q.risky_local_variable, "risky-local-variable")
    DEFSYM(Q.kill_emacs, "kill-emacs")
    DEFSYM(Q.kill_emacs_hook, "kill-emacs-hook")
    DEFSYM(Q.run_hook_query_error_with_timeout, "run-hook-query-error-with-timeout")
#
# #ifdef HAVE_UNEXEC
#   defsubr (&Sdump_emacs);
# #endif
